...
window.I18N = {
  ro: {
    ...
    "hero.headlineWhite": "Ce este",
    "hero.headlineAccent": "eCarnet?",
    "hero.sub1": "eCarnet este aplicația menită să ajute elevii și să digitalizeze actualul carnet al elevului.",
    "hero.sub2": "Rezolvă problemele carnetului fizic și oferă beneficii noi, într-un mod eficient și accesibil.",
    "hero.cta": "Află mai multe!",

    "problem.heading": "De ce au elevii nevoie de <span class=\"script-accent\">eCarnet?</span>",
    "problem.subtitle": "Deoarece actualul carnet are probleme grave. Iată câteva exemple:",
    ...
    "solution.heading": "Același carnet, doar că mereu cu tine.",
    "solution.easter": "totul pentru elevi",
    "solution.featuresHeading": "Acestea vor fi funcțiile principale",
  ...
  en: {
    ...
    "hero.headlineWhite": "What is",
    "hero.headlineAccent": "eCarnet?",
    "hero.sub1": "eCarnet is the app built to help students by digitalizing the current student card.",
    "hero.sub2": "It solves the paper card's problems and adds new benefits — efficient and accessible.",
    "hero.cta": "Learn more!",

    "problem.heading": "Why do students need <span class=\"script-accent\">eCarnet?</span>",
    "problem.subtitle": "Because the current card has serious problems. Here are a few examples:",
    ...
    "solution.heading": "The same card, just always with you.",
    "solution.easter": "everything for students",
    "solution.featuresHeading": "These will be the main features",
  ...
  ru: {
    ...
    "hero.headlineWhite": "Что такое",
    "hero.headlineAccent": "eCarnet?",
    "hero.sub1": "eCarnet — приложение, созданное, чтобы помочь ученикам и оцифровать нынешний ученический билет.",
    "hero.sub2": "Оно решает проблемы бумажного билета и даёт новые возможности — удобно и доступно.",
    "hero.cta": "Узнай больше!",

    "problem.heading": "Зачем ученикам нужен <span class=\"script-accent\">eCarnet?</span>",
    "problem.subtitle": "Потому что у нынешнего билета есть серьёзные проблемы. Вот несколько примеров:",
    ...
    "solution.heading": "Тот же билет, только всегда с тобой.",
    "solution.easter": "всё для учеников",
    "solution.featuresHeading": "Это будут основные функции",
